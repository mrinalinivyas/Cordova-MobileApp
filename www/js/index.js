...
function getList() {
	...
	$.ajax({
		...
		type : "GET",
		url : "https://192.168.1.31:8443/OnlineBookStore/allBook",
		dataType : 'jsonp',
...
function CategoryFunction() {
	 ...
	 function getCategoryBooks(category) {
	   ...
	   $.get("https://192.168.1.31:8443/OnlineBookStore/categoryviewservlet", {Category : category}, function(data) {
			var mylist = $("#book_listId");
			mylist.empty();
			var tempOpt;
...
function LoginUser() {
	...
	$.get("https://192.168.1.31:8443/OnlineBookStore/LoginUserServlet", {email : UserName, password : PassWord}, function(data) {
...
function RegisterUser() {
	...
	$.get("https://192.168.1.31:8443/OnlineBookStore/RegisterControllerServlet",
		{
			fname : Fname,
			lname : Lname,
			email : Reg_email,
...
function OrderSummary() {
  ...
  var orderDetails;
	...
	$.get("https://192.168.1.31:8443/OnlineBookStore/CreateOrderServlet",
	{
...
function confirmOrder() {
	...
	$.get("https://192.168.1.31:8443/OnlineBookStore/ConfirmOrderServlet",
	{
		Poid : poid,
		CartArray : cartArray
	},
